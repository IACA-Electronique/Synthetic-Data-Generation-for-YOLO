...
impl App {
    ...
    async fn run(&self) -> Result<(), String> {
        ...
        image.add_scalable_object_from_file("toto.png", 0,0, 0.3,60.0);
        // image.add_scalable_object_from_file("toto.png", 0,0, 0.3,0.0);
        // image.add_scalable_object_from_file("toto.png", 0,0, 0.3,90.0);
